...
class BottomNavigationWithSvgImages extends StatefulWidget {
  const BottomNavigationWithSvgImages({super.key});

  @override
  State<BottomNavigationWithSvgImages> createState() => _BottomNavigationWithSvgImagesState();
}

class _BottomNavigationWithSvgImagesState extends State<BottomNavigationWithSvgImages> {
